...
namespace Library_Managment_System.UI
{
    public partial class UserRegistration : Form
    {
        ...
        private void signupButton_Click(object sender, EventArgs e)
        {
            ...
            //if (passwordTxtBox.Text != confirmpassTxtBox.Text)
            else if (passwordTxtBox.Text.Equals(confirmpassTxtBox.Text) &&  (usrNameTxtBox.Text != "") && (emailTxtBox.Text != "") && (passwordTxtBox.Text != "") && (adressTxtBox.Text != "") && (dateBox.Text != "") && (paymentTxtBox.Text == "2000"))
            {
                try
                {
                    this.AddUser();
            ...
            {
                MessageBox.Show("Fill every textBox correctly.   2000 credits Adv. payment required");
            }
